...
export = (): void => {
    describe("Stringable extracting", () => {
        it("before()/beforeLast() extract the portion before a value", () => {
            ...
            expect(Str.of("ééé hannah").before("han").toString()).to.equal("ééé ");
            expect(Str.of("hannah").before("xxxx").toString()).to.equal("hannah");
            ...
            expect(Str.of("yvette").beforeLast("tte").toString()).to.equal("yve");
            expect(Str.of("yvette").beforeLast("t").toString()).to.equal("yvet");
            expect(Str.of("ééé yvette").beforeLast("yve").toString()).to.equal("ééé ");
            expect(Str.of("yvette").beforeLast("yve").toString()).to.equal("");
            expect(Str.of("yvette").beforeLast("xxxx").toString()).to.equal("yvette");
            expect(Str.of("yvette").beforeLast("").toString()).to.equal("yvette");
            expect(Str.of("yv0et0te").beforeLast("0").toString()).to.equal("yv0et");
            expect(Str.of("yv2et2te").beforeLast("2").toString()).to.equal("yv2et");
        });
        ...
        it("between()/betweenFirst() extract the portion between two values", () => {
            ...
            expect(Str.of("dddabcddd").between("a", "c").toString()).to.equal("b");
            expect(Str.of("hannah").between("ha", "ah").toString()).to.equal("nn");
            expect(Str.of("[a]ab[b]").between("[", "]").toString()).to.equal("a]ab[b");
            expect(Str.of("foofoobar").between("foo", "bar").toString()).to.equal("foo");
            expect(Str.of("foobarbar").between("foo", "bar").toString()).to.equal("bar");

            expect(Str.of("abc").betweenFirst("", "c").toString()).to.equal("abc");
            expect(Str.of("abc").betweenFirst("a", "").toString()).to.equal("abc");
            expect(Str.of("abc").betweenFirst("a", "c").toString()).to.equal("b");
            expect(Str.of("hannah").betweenFirst("ha", "ah").toString()).to.equal("nn");
            expect(Str.of("[a]ab[b]").betweenFirst("[", "]").toString()).to.equal("a");
            expect(Str.of("foofoobar").betweenFirst("foo", "bar").toString()).to.equal("foo");
            expect(Str.of("foobarbar").betweenFirst("foo", "bar").toString()).to.equal("");
        });
        ...
        it("after()/afterLast() extract the portion after a value", () => {
            ...
            expect(Str.of("ééé hannah").after("han").toString()).to.equal("nah");
            expect(Str.of("hannah").after("xxxx").toString()).to.equal("hannah");
            ...
            expect(Str.of("yvette").afterLast("yve").toString()).to.equal("tte");
            expect(Str.of("yvette").afterLast("t").toString()).to.equal("e");
            expect(Str.of("ééé yvette").afterLast("t").toString()).to.equal("e");
            expect(Str.of("yvette").afterLast("tte").toString()).to.equal("");
            expect(Str.of("yvette").afterLast("xxxx").toString()).to.equal("yvette");
            expect(Str.of("yvette").afterLast("").toString()).to.equal("yvette");
            expect(Str.of("yv0et0te").afterLast("0").toString()).to.equal("te");
            expect(Str.of("yv2et2te").afterLast("2").toString()).to.equal("te");
            expect(Str.of("----foo").afterLast("---").toString()).to.equal("foo");
        });
        ...
        it("excerpt() extracts a snippet around a phrase", () => {
            ...
            expect(Str.of("This is a beautiful morning").excerpt("beautiful", 5)).to.equal("...is a beautiful morn...");
        });
    });
};
