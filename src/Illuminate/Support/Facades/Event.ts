...
export class Event extends Facade {
    ...
    declare public static hasWildcardListeners: Forwarded<
        EventDispatcher["hasWildcardListeners"]
    >;
    ...
    declare public static getListeners: Forwarded<
        EventDispatcher["getListeners"]
    >;
    declare public static makeListener: Forwarded<
        EventDispatcher["makeListener"]
    >;
    declare public static createClassListener: Forwarded<
        EventDispatcher["createClassListener"]
    >;
    ...
    declare public static getRawListeners: Forwarded<
        EventDispatcher["getRawListeners"]
    >;
